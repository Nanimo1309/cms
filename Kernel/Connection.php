<?php
	class Connection
	{
		private static $host = 'sql.server581250.nazwa.pl';
		private static $username = 'server581250_cracowtrips24';
		private static $passwd = 'Tokaj1410';
		private static $dbname = 'server581250_cracowtrips24';
